...
export const TRANSLATIONS = {
    TR: {
        ...
        actionClientProfile: 'Müşteri Profili',
        actionClientIdeas: 'Fikirleri',
        actionClientPending: 'Tüm Bekleyen İşler',
        colClient: 'Müşteri',
        colJob: 'İş Tanımı',
        colAssignee: 'Kişi',
        colDeadline: 'Termin',
    ...
    EN: {
        ...
        actionClientProfile: 'Client Profile',
        actionClientIdeas: 'Ideas',
        actionClientPending: 'All Pending Jobs',
        colClient: 'Client',
        colJob: 'Job Title',
